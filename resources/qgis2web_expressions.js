...
function exp_PP_EW_Schacht_R_3rule0_eval_expression(context) {
    // pp_modell = 8

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('pp_modell')  == 8);
    } else {
        return (feature.get('pp_modell')  == 8);
    }
}
...
function exp_PP_EW_Schacht_R_3rule1_eval_expression(context) {
    // grafische_darstellung = 'fiktiver Auslass' AND pp_modell = 8

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('grafische_darstellung')  == 'fiktiver Auslass') && (feature.get('pp_modell')  == 8));
    } else {
        return ((feature.get('grafische_darstellung')  == 'fiktiver Auslass') && (feature.get('pp_modell')  == 8));
    }
}
...
function exp_PP_EW_Schacht_R_3rule2_eval_expression(context) {
    // grafische_darstellung = 'fiktiver Schacht' AND pp_modell = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('grafische_darstellung')  == 'fiktiver Schacht') && (feature.get('pp_modell')  == 1));
    } else {
        return ((feature.get('grafische_darstellung')  == 'fiktiver Schacht') && (feature.get('pp_modell')  == 1));
    }
}
...
function exp_PP_EW_Schacht_R_3rule4_eval_expression(context) {
    // pp_modell = 0 OR pp_modell IS NULL

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('pp_modell')  == 0) || (feature.get('pp_modell')  === null));
    } else {
        return ((feature.get('pp_modell')  == 0) || (feature.get('pp_modell')  === null));
    }
}